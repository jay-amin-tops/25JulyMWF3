...
<body>
    ...
    <p>1994 rusmus ledorf invented the PHP (1995 published)</p>
    <p>earlier its called as Personal Home Page its use for creating online resume</p>
    <p>Server Side Scripting Lang</p>
    <p>can do some dynamic operation like -*/+ conparesion <=> and we are also able to make database connection with PHP</p>
    <p> Zend It was originally developed by Andi Gutmans and Zeev Suraski while they were students at the Technion – Israel Institute of Technology</p>
    ...
    <p>easy to integrate with DB</p>
    <p>so many pre definded functions are there for developer helps</p>
    <p>so many pre definded Framewors and CMS are available for creating our website quickly</p>
    <img src="php-video-tutorial.png" alt="">
</body>
